...
complete -c anthropic-cli --no-files \
 ...
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from completions.create" \
   -l model \
   -ra "claude-3-7-sonnet-latest claude-3-7-sonnet-20250219 claude-3-5-haiku-latest claude-3-5-haiku-20241022 claude-3-5-sonnet-latest claude-3-5-sonnet-20241022 claude-3-5-sonnet-20240620 claude-3-opus-latest claude-3-opus-20240229 claude-3-sonnet-20240229 claude-3-haiku-20240307 claude-2.1 claude-2.0"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.create" \
   -l messages.content.type \
   -ra "text image tool_use tool_result document thinking redacted_thinking"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.create" \
 ...
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.create" \
   -l tools.type \
   -ra "bash_20250124 text_editor_20250124"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.count_tokens" \
   -l messages.content.type \
   -ra "text image tool_use tool_result document thinking redacted_thinking"
 ...
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.batches.create" \
   -l requests.params.thinking.type \
   -ra "enabled disabled"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from messages.batches.create" \
 ...
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from beta.messages.create" \
   -l tools.type \
   -ra "custom computer_20241022 bash_20241022 text_editor_20241022 computer_20250124 bash_20250124 text_editor_20250124"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from beta.messages.create" \
   -l betas \
   -ra "message-batches-2024-09-24 prompt-caching-2024-07-31 computer-use-2024-10-22 computer-use-2025-01-24 pdfs-2024-09-25 token-counting-2024-11-01 token-efficient-tools-2025-02-19 output-128k-2025-02-19"
 complete -c anthropic-cli --no-files \
   -n "__fish_seen_subcommand_from beta.messages.create" \
   -l +beta \
   -ra "message-batches-2024-09-24 prompt-caching-2024-07-31 computer-use-2024-10-22 computer-use-2025-01-24 pdfs-2024-09-25 token-counting-2024-11-01 token-efficient-tools-2025-02-19 output-128k-2025-02-19"
